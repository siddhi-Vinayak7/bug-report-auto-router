    ...
    if api_key:
        try:
            ...
            prompt = (
                ...
                f"Only respond with INSUFFICIENT_INFO if the bug report gives NO usable indication of what the problem might be "
                f"(e.g. it is a total non-answer like 'I don't know', 'n/a', 'test', or lacks any indication of an issue).\n"
                f"If the report names or implies ANY real module or problem area (even briefly or vaguely), make your best judgment call "
                f"for both module and severity. Do NOT use INSUFFICIENT_INFO merely because severity or module is uncertain — use your best judgment in those cases.\n\n"
                f"If you use INSUFFICIENT_INFO, respond with exactly:\n"
